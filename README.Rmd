...
[![Travis](https://travis-ci.org/rstudio/travis.svg?branch=master)](https://travis-ci.org/rstudio/nomnoml) [![AppVeyor build status](https://ci.appveyor.com/api/projects/status/56dd82589vji7saw?svg=true)](https://ci.appveyor.com/project/rstudio/nomnoml) [![CRAN_Status_Badge](https://www.r-pkg.org/badges/version/nomnoml)](https://cran.r-project.org/package=nomnoml) <a href="https://www.r-pkg.org/pkg/nomnoml"><img src="https://cranlogs.r-pkg.org/badges/nomnoml?color=brightgreen" style=""></a>
...
```{nomnoml nomnoml-vertical, width=6, height=1, echo=FALSE}
#direction: down
[Hello]-[World!]
```
...
```{nomnoml nomnoml-svg, width=6, height=1, svg=TRUE, echo=FALSE}
#stroke: orange
#.highlight: fill=#8f8 dashed visual=ellipse
